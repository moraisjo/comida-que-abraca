...
const StockTable: React.FC<StockTableProps> = ({ donations }) => {
  ...
  const partners = [
    { id: 1, name: "Januário", email: "", password: "", phone: "", address: "", wantsToDonate: true, wantsToReceiveDonations: true, registrationDate: "", legalEntityType: "" },
    { id: 2, name: "Januário", email: "", password: "", phone: "", address: "", wantsToDonate: true, wantsToReceiveDonations: true, registrationDate: "", legalEntityType: "" },
    { id: 3, name: "Januário", email: "", password: "", phone: "", address: "", wantsToDonate: true, wantsToReceiveDonations: true, registrationDate: "", legalEntityType: "" },
    { id: 4, name: "Januário", email: "", password: "", phone: "", address: "", wantsToDonate: true, wantsToReceiveDonations: true, registrationDate: "", legalEntityType: "" },
