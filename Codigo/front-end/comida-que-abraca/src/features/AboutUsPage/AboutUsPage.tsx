  ...
  return (
    <>
      ...
      <div className="max-w-4xl mx-auto px-6 py-10 space-y-10">
        {/* Seções */}
        <Paper
          sx={{ p: 2, backgroundColor: "#F2821A", mb: 2, mr: 2, ml: 2, mt: 2 }}
        >
          <Stack direction="row" alignItems="center" spacing={1}>
            <Heart />
            <Typography color="#FFFF">
              <strong>O que é o Projeto Comida Que Abraça?</strong>
            </Typography>
          </Stack>
          <Typography color="#FFFF">
            Nós temos uma missão e levamos ela no peito, com amor e entrega. 💖
            <br />
            ...
            <br /> Trabalhamos para estimular a esperança em um mundo melhor,
            pelas vias da solidariedade e da fraternidade. ✨
          </Typography>
        </Paper>
        ...
        <Paper sx={{ p: 2, backgroundColor: "#F2821A", mb: 2, mr: 2, ml: 2 }}>
          <Stack direction="row" alignItems="center" spacing={1}>
            <Globe />
            <Typography color="#FFFF">
              <strong>Como pensamos e no que acreditamos</strong>
            </Typography>
          </Stack>
          <Typography color="#FFFF">
            ...
            fraternidade. 🤝 <br /> Queremos ser reconhecidos por um trabalho
            sólido e gradual, com credibilidade e transparência. Trabalhamos
            para transformar vidas e promover o desenvolvimento social e
            econômico. 💼🌍
          </Typography>
        </Paper>
        ...
        <Paper sx={{ p: 2, backgroundColor: "#F2821A", mb: 2, mr: 2, ml: 2 }}>
          <Stack direction="row" alignItems="center" spacing={1}>
            <Star />
            <Typography color="#FFFF">
              <strong>Por que fazemos tudo isso?</strong>
            </Typography>
          </Stack>
          <Typography color="#FFFF">
        ...
        <Paper sx={{ p: 2, backgroundColor: "#F2821A", mb: 2, mr: 2, ml: 2 }}>
          <Stack direction="row" alignItems="center" spacing={1}>
            <Activity />
            <Typography color="#FFFF">
              <strong>Como fazemos o que fazemos?</strong>
            </Typography>
          </Stack>
          <Typography color="#FFFF">
            Desenvolvendo competências socioemocionais 💡
            <br /> Criando ações que impactam no desenvolvimento humano, com
            responsabilidade, criatividade, ética e cooperação 🙌 <br />{" "}
            Estimulando pessoas a sonhar — porque sonhos criam metas e nos
            aproximam da realidade que queremos viver 💭🎯
          </Typography>
        </Paper>
      </div>
      <Footer />
