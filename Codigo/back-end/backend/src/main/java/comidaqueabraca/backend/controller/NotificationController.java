...
public class NotificationController {
    ...
    @Operation(
            ...
            description = "Retorna todas as notificações de um usuário específico, com ordenação por visualização e data de envio. As notificações não visualizadas aparecem primeiro, seguidas pelas visualizadas — ambas ordenadas da mais recente para a mais antiga."
    )
    @ApiResponses(value = {
    ...
    public List<NotificationEntity> getNotificationsByUser(
            @Parameter(description = "ID do usuário para buscar notificações", example = "1")
